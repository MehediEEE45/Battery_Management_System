...
```json
{ "device_id": "panel_01", "voltage": 12.4, "current": 1.8, "power": 22.3, "temperture": 25 C,"ts": 167" }
```
...
Live demo (Netlify): [https://power-monitor.netlify.app/](https://iotpowerhub.netlify.app/)
